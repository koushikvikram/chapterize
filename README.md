...
![Chapterize start screen](./docs/assets/screenshot.png)

![Chapterize upload screen](./docs/assets/screenshot_upload.png)

![Chapterize detected chapters and export screen](./docs/assets/screenshot_detect_split.png)
